...
int main()
{
    int i = 0, c = 1, j = 0, mainChoice, cost[24] = {99, 195, 395, 155, 295, 445, 155, 295, 445, 195, 365, 545, 155, 295, 445, 225, 425, 635, 235, 455, 685, 235, 455, 685};
    int totalCost = 0, a[10];
    char name[20];
    ...
    do
    {
        if (c == 1)
        {
            ...
            {
                int subChoice;
                printf(" Which Pizza would you like to have?\n1 - Margherita\n2 - Spicy Triple Tango\n3 - Double Cheese Margherita\n4 - Farm House\n5 - Exit\n");
                scanf("%d", &subChoice);
                if (subChoice != 5)
                {
                    int sizeChoice;
                    printf(" Which size of Pizza would you want?\n1 - Small\n2 - Medium\n3 - Large\n");
                    scanf("%d", &sizeChoice);
                    if (sizeChoice == 1)
